...
const Navbar = () => {
  const { user, loading, logOut ,setTheme, theme} = use(AuthContext);
  ...
  return (
    <div className={`bg-base-100 shadow-sm ${theme === 'dark' && 'text-white'}`}>
      <nav className="navbar container px-5 lg:px-12 mx-auto">
